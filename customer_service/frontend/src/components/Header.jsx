...
export default function Header() {
  ...
  const leftLngButtonClassNames = classNames(
    "language-switch__half", 
    "language-switch__left_half", 
    {"language-switch__half_active": lngs[0].isActive});
  const rightLngButtonClassNames = classNames(
    "language-switch__half", 
    "language-switch__right_half", 
    {"language-switch__half_active": lngs[1].isActive});
